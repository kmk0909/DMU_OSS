...
![image](https://user-images.githubusercontent.com/99963066/201923455-0211c5a6-5c50-4f94-8d46-7961e537eed4.png)

위와 같이 8.5.2까지 진행하여 실습을 위한 충돌을 만든 상황이라고 가정한 채 소스트리에서 병합 충돌을 확인해 본다.

충돌이 발생하면 '스테이지에 올라간 파일'과 '스테이지에 올라가지 않은 파일' 두 영역에 파일이 표시되는데 파일을 클릭하면 충돌 메시지 확인이 가능하다.

![image](https://user-images.githubusercontent.com/99963066/201924170-d8be5bb0-cdfe-42d4-9aa1-dbf2e334ac03.png)

**충돌한 파일에서 마우스 오른쪽 버튼을 눌러 '충돌 해결' 메뉴를 선택하면 다양한 해결 옵션이 보이는데 '해결된 것으로 표시'를 클릭하면 두 브랜치가 하나로 표시되면서 충돌이 해결된다.**

![image](https://user-images.githubusercontent.com/99963066/201924591-d2065aae-87c8-4c66-86f9-f20512e3d5e1.png)  
<br/>
